...
const CustomGameBoard: React.FC<CustomGameBoardProps> = ({ squares, questions }) => {
  ...
  // Create board squares based on number of squares
  const renderSquares = () => {
    const squaresArray = [];
      ...
      <div className="flex flex-col items-center">
        ...
        {currentQuestion && (
          <div className="mt-2 w-full p-4 bg-white rounded-lg shadow-md">
            ...
            <button 
              className="w-full py-2 bg-blue-100 hover:bg-blue-200 rounded-lg mt-2 transition-colors"
